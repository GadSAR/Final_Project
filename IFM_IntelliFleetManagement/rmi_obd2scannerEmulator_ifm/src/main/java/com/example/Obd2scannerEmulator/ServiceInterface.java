...
public interface ServiceInterface extends Remote {
    ...
    String message(UUID userID, String VEHICLE_ID, Integer SPEED, Double THROTTLE_POS, Integer ENGINE_RPM,
    ...
    String SaveToDatabase(UUID userID, String VEHICLE_ID, Integer SPEED, Double THROTTLE_POS, Integer ENGINE_RPM,
                          Double ENGINE_LOAD, Integer ENGINE_COOLANT_TEMP, Integer INTAKE_MANIFOLD_PRESSURE, Double MAF,
                          Double FUEL_LEVEL, Integer FUEL_PRESSURE, Double TIMING_ADVANCE, String TROUBLE_CODES, Byte ISSUES)
            throws RemoteException, ServerNotActiveException;
}
